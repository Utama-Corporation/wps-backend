...
const templatePath = path.join(__dirname, "fj-label-pdf.html");
...
/**
 * @param {object} data hasil labelFjService.getLabelData(noFJ) + { qrBase64 }
 * @returns {string} HTML siap render ke PDF
 */
function buildFjLabelHtml(data) {
...
module.exports = { buildFjLabelHtml };
