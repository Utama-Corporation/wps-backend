...
const templatePath = path.join(__dirname, "s4s-label-pdf.html");
...
/**
 * @param {object} data hasil labelS4sService.getLabelData(noS4S) + { qrBase64 }
 * @returns {string} HTML siap render ke PDF
 */
function buildS4sLabelHtml(data) {
  ...
  return html
    .replace(/{{noS4S}}/g, esc(data.noS4S))
...
module.exports = { buildS4sLabelHtml };
