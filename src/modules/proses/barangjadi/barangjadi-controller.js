...
exports.getBarangJadiStock = (req, res) => handle(req, res, "getStock", "Stok Barang Jadi");
exports.getBarangJadiLabels = (req, res) => handle(req, res, "getLabels", "Label Barang Jadi", true);
