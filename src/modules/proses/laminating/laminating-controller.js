const service = require("./laminating-service");
...
exports.getLaminatingStock = (req, res) => handle(req, res, "getStock", "Stok Laminating");
exports.getLaminatingLabels = (req, res) => handle(req, res, "getLabels", "Label Laminating", true);
