const service = require("./moulding-service");
...
exports.getMouldingStock = (req, res) => handle(req, res, "getStock", "Stok Moulding");
exports.getMouldingLabels = (req, res) => handle(req, res, "getLabels", "Label Moulding", true);
