const service = require("./st-service");
...
exports.getStStock = (req, res) => handle(req, res, "getStock", "Stok ST");
exports.getStLabels = (req, res) => handle(req, res, "getLabels", "Label ST", true);
